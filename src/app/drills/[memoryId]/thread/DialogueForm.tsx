...
function TextArea({
  ...
  return (
    <TextareaAutosize
      ...
      name="comment"
      id="comment"
      className="mb-6 block w-full rounded-lg py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus-within:ring-2 focus-within:ring-orange-600 disabled:cursor-wait disabled:bg-gray-50 sm:text-sm sm:leading-6"
    />
  )
}
