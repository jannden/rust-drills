          ...
          <div className="relative mx-auto grid max-w-2xl grid-cols-1 gap-x-32 gap-y-14 xl:max-w-none xl:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-lg tracking-tight text-blue-900">
                Sign up to our newsletter and we&apos;ll send you a comprehensive guide to help you learn a new
                language.
              </p>
            </div>
            <form>
              <label
                ...
                className="cursor-pointer text-lg font-semibold tracking-tight text-blue-900"
              >
              ...
              <div className="mt-5 flex rounded-3xl bg-white py-2.5 pr-2.5 shadow-xl shadow-blue-900/5 focus-within:ring-2 focus-within:ring-blue-900">
                <input
                  ...
                  className="-my-2.5 flex-auto border-0 bg-transparent pl-6 pr-2.5 text-base text-slate-900 ring-0 placeholder:text-slate-400 focus:outline-none focus:ring-0"
                />
                <Button type="submit">
