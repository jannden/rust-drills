    ...
    <div className="group">
      ...
      <div className="relative hidden flex-col items-center group-hover:flex">
        <div className="absolute top-0 mt-2 flex flex-col items-center rounded-t-full">
          <div className="-mb-2 size-3 rotate-45 bg-orange-600"></div>
          <span className="relative z-10 w-32 rounded-sm bg-orange-600 p-2 text-center text-sm text-white shadow-lg">
            {text}
          </span>
        </div>
      </div>
